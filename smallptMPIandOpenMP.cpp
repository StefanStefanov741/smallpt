//mpic++ -o -std=c++11 -O3 -fopenmp smallptMPIandOpenMP.cpp -o smallptMPIandOpenMP
//mpiexec -n 6 ./smallptMPIandOpenMP
...
int main(int argc, char *argv[]) {
  ...
  if (nodeID == 0) {
    ...
    for (int i = 1; i < nodesCount; i++) {
      MPI_Recv(final_canvas + i * numRows * w, numRows*3 * w, MPI_DOUBLE, i, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
    }
